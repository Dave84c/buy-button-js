...
const notesTemplate = '<input class="{{data.classes.product.productNote}}" type="text"  aria-label="Note" value="{{data.productNote}}" data-element="product.noteInput"></input>'
